...
func init() {
	permissionsCmd.AddCommand(permissionsGetCmd)
	gsmhelpers.AddFlags(permissionFlags, permissionsGetCmd.Flags(), permissionsGetCmd.Use)
	markFlagsRequired(permissionsGetCmd, permissionFlags, "")
}
