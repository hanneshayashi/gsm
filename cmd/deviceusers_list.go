...
var deviceUsersListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		gsmhelpers.StreamOrCollect(gsmci.ListDeviceUsers(flags["parent"].GetString(), flags["customer"].GetString(), flags["filter"].GetString(), flags["orderBy"].GetString(), flags["fields"].GetString()), streamOutput, compressOutput)
	},
}
