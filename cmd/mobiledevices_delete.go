...
// mobileDevicesDeleteCmd represents the delete command
var mobileDevicesDeleteCmd = &cobra.Command{
	Use:               "delete",
	Short:             "Removes a mobile device.",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/mobiledevices/delete",
