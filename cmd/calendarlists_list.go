...
var calendarListsListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		gsmhelpers.StreamOrCollect(gsmcalendar.ListCalendarListEntries(flags["minAccessRole"].GetString(), flags["fields"].GetString(), flags["showHidden"].GetBool(), flags["showDeleted"].GetBool()), streamOutput, compressOutput)
	},
}
