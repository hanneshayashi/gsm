...
var gmailUsersCmd = &cobra.Command{
	...
	Long:              "Implements the API documented at https://developers.google.com/workspace/gmail/api/reference/rest/v1/users",
...
var gmailUserFlags map[string]*gsmhelpers.Flag = map[string]*gsmhelpers.Flag{
	"userId": {
		...
		Defaults:     map[string]gsmhelpers.FlagValue{"getProfile": gsmhelpers.StringVal("me")},
	},
	"fields": {
		AvailableFor: []string{"getProfile"},
		Type:         gsmhelpers.FlagString,
