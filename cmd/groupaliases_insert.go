...
func init() {
	groupAliasesCmd.AddCommand(groupAliasesInsertCmd)
	gsmhelpers.AddFlags(groupAliasFlags, groupAliasesInsertCmd.Flags(), groupAliasesInsertCmd.Use)
	markFlagsRequired(groupAliasesInsertCmd, groupAliasFlags, "")
}
