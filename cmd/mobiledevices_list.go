...
var mobileDevicesListCmd = &cobra.Command{
	...
	Long:              "Implements the API documented at https://developers.google.com/admin-sdk/directory/v1/reference/mobiledevices/list",
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		e := <-err
		if e != nil {
			log.Fatalf("Error listing mobile devices: %v", e)
		}
	},
}
