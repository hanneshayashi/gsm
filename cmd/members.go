...
var membersCmd = &cobra.Command{
	Use:               "members",
	Short:             "Manage group members (Part of Admin SDK API)",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/members",
