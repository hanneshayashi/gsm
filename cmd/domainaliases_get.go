...
func init() {
	domainAliasesCmd.AddCommand(domainAliasesGetCmd)
	gsmhelpers.AddFlags(domainAliasFlags, domainAliasesGetCmd.Flags(), domainAliasesGetCmd.Use)
	markFlagsRequired(domainAliasesGetCmd, domainAliasFlags, "")
}
