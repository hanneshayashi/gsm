...
func init() {
	...
	gsmhelpers.AddFlags(roleAssignmentFlags, roleAssignmentsListCmd.Flags(), roleAssignmentsListCmd.Use)
	markFlagsRequired(roleAssignmentsListCmd, roleAssignmentFlags, "")
}
