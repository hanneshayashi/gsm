...
If you're using this API to manage another organization, use customers/{customer_id}, where customer_id is the customer to whom the device belongs.`,
		Defaults: map[string]gsmhelpers.FlagValue{"approve": gsmhelpers.StringVal("customers/my_customer"), "block": gsmhelpers.StringVal("customers/my_customer"), "cancelWipe": gsmhelpers.StringVal("customers/my_customer"), "create": gsmhelpers.StringVal("customers/my_customer"), "delete": gsmhelpers.StringVal("customers/my_customer"), "get": gsmhelpers.StringVal("customers/my_customer"), "list": gsmhelpers.StringVal("customers/my_customer"), "wipe": gsmhelpers.StringVal("customers/my_customer")},
	},
	"fields": {
		AvailableFor: []string{"approve", "block", "cancelWipe", "delete", "get", "list", "wipe"},
		Type:         gsmhelpers.FlagString,
