...
func init() {
	orgUnitsCmd.AddCommand(orgUnitsGetCmd)
	gsmhelpers.AddFlags(orgUnitFlags, orgUnitsGetCmd.Flags(), orgUnitsGetCmd.Use)
	markFlagsRequired(orgUnitsGetCmd, orgUnitFlags, "")
}
