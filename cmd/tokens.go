...
var tokensCmd = &cobra.Command{
	Use:               "tokens",
	Short:             "Managed OAuth access tokens for users (Part of Admin SDK API)",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/tokens",
