...
var drivesListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		gsmhelpers.StreamOrCollect(gsmdrive.ListDrives(flags["q"].GetString(), flags["fields"].GetString(), flags["useDomainAdminAccess"].GetBool()), streamOutput, compressOutput)
	},
}
