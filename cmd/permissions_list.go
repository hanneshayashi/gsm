...
var permissionsListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		gsmhelpers.StreamOrCollect(gsmdrive.ListPermissions(flags["fileId"].GetString(), flags["includePermissionsForView"].GetString(), flags["fields"].GetString(), flags["useDomainAdminAccess"].GetBool()), streamOutput, compressOutput)
	},
}
