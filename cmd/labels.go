...
var labelsCmd = &cobra.Command{
	...
	Long:              "Implements the API documented at https://developers.google.com/workspace/gmail/api/reference/rest/v1/users.labels",
...
var labelFlags map[string]*gsmhelpers.Flag = map[string]*gsmhelpers.Flag{
	"userId": {
		...
		Defaults:     map[string]gsmhelpers.FlagValue{"create": gsmhelpers.StringVal("me"), "delete": gsmhelpers.StringVal("me"), "get": gsmhelpers.StringVal("me"), "list": gsmhelpers.StringVal("me"), "patch": gsmhelpers.StringVal("me")},
	},
	"id": {
	...
	"messageListVisibility": {
		...
		Defaults:     map[string]gsmhelpers.FlagValue{"create": gsmhelpers.StringVal("SHOW")},
	},
	"labelListVisibility": {
		AvailableFor: []string{"create", "patch"},
		Type:         gsmhelpers.FlagString,
		...
		Defaults:     map[string]gsmhelpers.FlagValue{"create": gsmhelpers.StringVal("LABEL_SHOW")},
	},
	"textColor": {
		AvailableFor: []string{"create", "patch"},
		Type:         gsmhelpers.FlagString,
