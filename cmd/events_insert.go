...
func init() {
	eventsCmd.AddCommand(eventsInsertCmd)
	gsmhelpers.AddFlags(eventFlags, eventsInsertCmd.Flags(), eventsInsertCmd.Use)
	markFlagsRequired(eventsInsertCmd, eventFlags, "")
}
