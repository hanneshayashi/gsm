...
var contactGroupsMembersModifyBatchCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		maps, err := gsmhelpers.GetBatchMaps(cmd, contactGroupMemberFlags, batchThreads)
		if err != nil {
			log.Fatalln(err)
		}
		results := make(chan *people.ModifyContactGroupMembersResponse, batchThreads)
...
func init() {
	gsmhelpers.InitBatchCommand(contactGroupsMembersModifyCmd, contactGroupsMembersModifyBatchCmd, contactGroupMemberFlags, contactGroupMemberFlagsALL, batchFlags)
}
