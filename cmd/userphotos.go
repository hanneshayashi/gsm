...
var userPhotosCmd = &cobra.Command{
	Use:               "userPhotos",
	Short:             "Manage user photos (Part of Admin SDK API)",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/users.photos",
