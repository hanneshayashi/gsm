...
// driveLabelsDisableSelectionChoiceCmd represents the disableSelectionChoice command
var driveLabelsDisableSelectionChoiceCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		r, err := mapToDisableDriveLabelFieldSelectionChoiceRequest(flags)
		if err != nil {
			log.Fatalf("Error building Drive Label DisableSelectionChoiceRequest object: %v\n", err)
		}
...
func init() {
	gsmhelpers.InitCommand(driveLabelsCmd, driveLabelsDisableSelectionChoiceCmd, driveLabelFlags)
}
