...
// orgUnitsDeleteCmd represents the delete command
var orgUnitsDeleteCmd = &cobra.Command{
	Use:               "delete",
	Short:             "Removes an organizational unit.",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/orgunits/delete",
