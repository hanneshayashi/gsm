...
var verificationCodesCmd = &cobra.Command{
	...
	Short:             "Manage backup Verification Codes for Users (Part of Admin SDK API)",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/verificationCodes",
