...
// groupsDeleteCmd represents the delete command
...
func init() {
	...
	gsmhelpers.AddFlags(groupFlags, groupsDeleteCmd.Flags(), groupsDeleteCmd.Use)
	markFlagsRequired(groupsDeleteCmd, groupFlags, "")
}
