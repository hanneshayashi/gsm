...
// twostepverificationTurnOffCmd represents the batch command
...
func init() {
	gsmhelpers.InitCommand(twoStepVerificationCmd, twoStepVerificationTurnOffCmd, twoStepVerificationFlags)
}
