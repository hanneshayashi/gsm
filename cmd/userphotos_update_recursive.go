...
// userPhotosUpdateRecursiveCmd represents the recursive command
...
func init() {
	gsmhelpers.InitRecursiveCommand(userPhotosUpdateCmd, userPhotosUpdateRecursiveCmd, userPhotoFlags, recursiveUserFlags)
}
