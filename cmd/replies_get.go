...
// repliesGetCmd represents the get command
...
func init() {
	repliesCmd.AddCommand(repliesGetCmd)
	gsmhelpers.AddFlags(replyFlags, repliesGetCmd.Flags(), repliesGetCmd.Use)
	markFlagsRequired(repliesGetCmd, replyFlags, "")
}
