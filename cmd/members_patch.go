...
func init() {
	membersCmd.AddCommand(membersPatchCmd)
	gsmhelpers.AddFlags(memberFlags, membersPatchCmd.Flags(), membersPatchCmd.Use)
	markFlagsRequired(membersPatchCmd, memberFlags, "")
}
