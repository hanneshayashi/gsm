...
// userInvitationsIsInvitableUserBatchCmd represents the batch command
...
func init() {
	gsmhelpers.InitBatchCommand(userInvitationsIsInvitableUserCmd, userInvitationsIsInvitableUserBatchCmd, userInvitationFlags, userInvitationFlagsALL, batchFlags)
}
