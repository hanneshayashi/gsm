...
// domainAliasesInsertBatchCmd represents the batch command
var domainAliasesInsertBatchCmd = &cobra.Command{
	Use:   "batch",
	Short: "Batch inserts Domain aliases of a customer using a CSV file as input.",
	Long:  "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/domainAliases/insert",
