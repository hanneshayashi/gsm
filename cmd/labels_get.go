...
// labelsGetCmd represents the get command
var labelsGetCmd = &cobra.Command{
	Use:               "get",
	Short:             "Gets the specified label.",
	Long:              "Implements the API documented at https://developers.google.com/workspace/gmail/api/reference/rest/v1/users.labels/get",
