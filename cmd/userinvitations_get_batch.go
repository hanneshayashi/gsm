...
// userInvitationsGetBatchCmd represents the batch command
...
func init() {
	gsmhelpers.InitBatchCommand(userInvitationsGetCmd, userInvitationsGetBatchCmd, userInvitationFlags, userInvitationFlagsALL, batchFlags)
}
