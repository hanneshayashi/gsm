...
var calendarACLListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		gsmhelpers.StreamOrCollect(gsmcalendar.ListACLs(flags["calendarId"].GetString(), flags["fields"].GetString(), flags["showDeleted"].GetBool()), streamOutput, compressOutput)
	},
}
