...
func init() {
	smimeInfoCmd.AddCommand(smimeInfoGetCmd)
	gsmhelpers.AddFlags(smimeInfoFlags, smimeInfoGetCmd.Flags(), smimeInfoGetCmd.Use)
	markFlagsRequired(smimeInfoGetCmd, smimeInfoFlags, "")
}
