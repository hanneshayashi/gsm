...
func init() {
	gsmhelpers.InitBatchCommand(forwardingAddressesDeleteCmd, forwardingAddressesDeleteBatchCmd, forwardingAddressFlags, forwardingAddressFlagsALL, batchFlags)
}
