...
func init() {
	threadsCmd.AddCommand(threadsTrashCmd)
	gsmhelpers.AddFlags(threadFlags, threadsTrashCmd.Flags(), threadsTrashCmd.Use)
	markFlagsRequired(threadsTrashCmd, threadFlags, "")
}
