...
func init() {
	contactGroupsCmd.AddCommand(contactGroupsGetCmd)
	gsmhelpers.AddFlags(contactGroupFlags, contactGroupsGetCmd.Flags(), contactGroupsGetCmd.Use)
	markFlagsRequired(contactGroupsGetCmd, contactGroupFlags, "")
}
