...
var roleAssignmentsInsertCmd = &cobra.Command{
	...
	Long:              "Implements the API documented at https://developers.google.com/admin-sdk/directory/reference/rest/v1/roleAssignments/insert",
...
func init() {
	gsmhelpers.InitCommand(roleAssignmentsCmd, roleAssignmentsInsertCmd, roleAssignmentFlags)
}
