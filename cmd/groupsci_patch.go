...
func init() {
	groupsCiCmd.AddCommand(groupsCiPatchCmd)
	gsmhelpers.AddFlags(groupCiFlags, groupsCiPatchCmd.Flags(), groupsCiPatchCmd.Use)
	markFlagsRequired(groupsCiPatchCmd, groupCiFlags, "")
}
