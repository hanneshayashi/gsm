...
var userUsageReportsCmd = &cobra.Command{
	...
	Short:             "Manage (get) User Usage Reports (Part of Admin SDK API)",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/reports/reference/rest/v1/userUsageReport",
