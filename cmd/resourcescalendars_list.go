...
var calendarResourcesListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		result, err := gsmadmin.ListCalendarResources(flags["customer"].GetString(), flags["orderBy"].GetString(), flags["query"].GetString(), flags["fields"].GetString())
		if err != nil {
			log.Fatalf("Error listing calendar resources: %v", err)
		}
