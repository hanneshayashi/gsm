...
func init() {
	contactGroupsCmd.AddCommand(contactGroupsListCmd)
	gsmhelpers.AddFlags(contactGroupFlags, contactGroupsListCmd.Flags(), contactGroupsListCmd.Use)
	markFlagsRequired(contactGroupsListCmd, contactGroupFlags, "")
}
