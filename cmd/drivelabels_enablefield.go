...
// driveLabelsEnableFieldCmd represents the enableField command
var driveLabelsEnableFieldCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		r, err := mapToEnableDriveLabelFieldRequest(flags)
		if err != nil {
...
func init() {
	gsmhelpers.InitCommand(driveLabelsCmd, driveLabelsEnableFieldCmd, driveLabelFlags)
}
