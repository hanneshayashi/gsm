...
func init() {
	calendarACLCmd.AddCommand(calendarACLGetCmd)
	gsmhelpers.AddFlags(calendarACLFlags, calendarACLGetCmd.Flags(), calendarACLGetCmd.Use)
	markFlagsRequired(calendarACLGetCmd, calendarACLFlags, "")
}
