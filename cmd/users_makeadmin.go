...
// usersMakeAdminCmd represents the makeAdmin command
var usersMakeAdminCmd = &cobra.Command{
	Use:               "makeAdmin",
	Short:             "(un)Makes a user a super administrator.",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/users/makeAdmin",
