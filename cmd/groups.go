...
var groupsCmd = &cobra.Command{
	Use:               "groups",
	Short:             "Implements the groups API (Part of Admin SDK API).",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/groups",
