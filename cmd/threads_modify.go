...
func init() {
	threadsCmd.AddCommand(threadsModifyCmd)
	gsmhelpers.AddFlags(threadFlags, threadsModifyCmd.Flags(), threadsModifyCmd.Use)
	markFlagsRequired(threadsModifyCmd, threadFlags, "")
}
