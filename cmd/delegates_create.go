...
func init() {
	delegatesCmd.AddCommand(delegatesCreateCmd)
	gsmhelpers.AddFlags(delegateFlags, delegatesCreateCmd.Flags(), delegatesCreateCmd.Use)
	markFlagsRequired(delegatesCreateCmd, delegateFlags, "")
}
