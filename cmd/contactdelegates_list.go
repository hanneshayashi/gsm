...
// contactDelegatesListCmd represents the list command
var contactDelegatesListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		if err != nil {
			log.Fatalf("Error listing contact delegates: %v", err)
		}
		if streamOutput {
...
func init() {
	gsmhelpers.InitCommand(contactDelegatesCmd, contactDelegatesListCmd, contactDelegateFlags)
}
