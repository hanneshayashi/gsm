...
// membersDeleteCmd represents the delete command
var membersDeleteCmd = &cobra.Command{
	Use:               "delete",
	Short:             "Removes a member from a group.",
	Long:              "Implements the API documented at https://developers.google.com/workspace/admin/directory/reference/rest/v1/members/delete",
