...
func init() {
	calendarsCmd.AddCommand(calendarsInsertCmd)
	gsmhelpers.AddFlags(calendarFlags, calendarsInsertCmd.Flags(), calendarsInsertCmd.Use)
	markFlagsRequired(calendarsInsertCmd, calendarFlags, "")
}
