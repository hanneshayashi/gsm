...
var repliesCreateBatchCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		flags, err := gsmhelpers.ConsolidateFlags(cmd, replyFlags)
		if err != nil {
...
func init() {
	gsmhelpers.InitBatchCommand(repliesCreateCmd, repliesCreateBatchCmd, replyFlags, replyFlagsALL, batchFlags)
}
