...
func init() {
	delegatesCmd.AddCommand(delegatesListCmd)
	gsmhelpers.AddFlags(delegateFlags, delegatesListCmd.Flags(), delegatesListCmd.Use)
	markFlagsRequired(delegatesListCmd, delegateFlags, "")
}
