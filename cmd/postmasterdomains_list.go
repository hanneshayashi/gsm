...
Newly created domains will not necessarily be added to the end of this list.`,
	Long:              "Implements the API documented at https://developers.google.com/workspace/gmail/postmaster/reference/rest/v1/domains/list",
	DisableAutoGenTag: true,
	Run: func(cmd *cobra.Command, _ []string) {
		flags := gsmhelpers.FlagsToMap(cmd.Flags())
		gsmhelpers.StreamOrCollect(gsmgmailpostmaster.ListDomains(flags["fields"].GetString()), streamOutput, compressOutput)
	},
}
