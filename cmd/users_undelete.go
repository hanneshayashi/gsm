...
func init() {
	usersCmd.AddCommand(usersUndeleteCmd)
	gsmhelpers.AddFlags(userFlags, usersUndeleteCmd.Flags(), usersUndeleteCmd.Use)
	markFlagsRequired(usersUndeleteCmd, userFlags, "")
}
