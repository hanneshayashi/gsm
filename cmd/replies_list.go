...
var repliesListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		gsmhelpers.StreamOrCollect(gsmdrive.ListReplies(flags["fileId"].GetString(), flags["commentId"].GetString(), flags["fields"].GetString(), flags["includeDeleted"].GetBool()), streamOutput, compressOutput)
	},
}
