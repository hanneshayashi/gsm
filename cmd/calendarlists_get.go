...
func init() {
	calendarListsCmd.AddCommand(calendarListsGetCmd)
	gsmhelpers.AddFlags(calendarListFlags, calendarListsGetCmd.Flags(), calendarListsGetCmd.Use)
	markFlagsRequired(calendarListsGetCmd, calendarListFlags, "")
}
