...
func init() {
	domainAliasesCmd.AddCommand(domainAliasesListCmd)
	gsmhelpers.AddFlags(domainAliasFlags, domainAliasesListCmd.Flags(), domainAliasesListCmd.Use)
	markFlagsRequired(domainAliasesListCmd, domainAliasFlags, "")
}
