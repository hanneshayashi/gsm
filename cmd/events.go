...
If you want to access the primary calendar of the currently logged in user, use the "primary" keyword.`,
		Defaults: map[string]gsmhelpers.FlagValue{"delete": gsmhelpers.StringVal("primary"), "get": gsmhelpers.StringVal("primary"), "import": gsmhelpers.StringVal("primary"), "insert": gsmhelpers.StringVal("primary"), "instances": gsmhelpers.StringVal("primary"), "list": gsmhelpers.StringVal("primary"), "move": gsmhelpers.StringVal("primary"), "patch": gsmhelpers.StringVal("primary"), "quickAdd": gsmhelpers.StringVal("primary")},
	},
...
Version 1 enables support for copying of ConferenceData as well as for creating new conferences using the createRequest field of conferenceData.`,
		Defaults: map[string]gsmhelpers.FlagValue{"import": gsmhelpers.Int64Val(1), "insert": gsmhelpers.Int64Val(1), "patch": gsmhelpers.Int64Val(1)},
	},
	"maxAttendees": {
...
none          - No notifications are sent. This value should only be used for migration use cases (note that in most migration cases the import method should be used).`,
		Defaults: map[string]gsmhelpers.FlagValue{"delete": gsmhelpers.StringVal("none"), "insert": gsmhelpers.StringVal("none"), "move": gsmhelpers.StringVal("none"), "patch": gsmhelpers.StringVal("none"), "quickAdd": gsmhelpers.StringVal("none")},
	},
	"supportsAttachments": {
		AvailableFor: []string{"import", "insert", "patch"},
...
For single events this field is optional and indicates a custom time zone for the event start/end.`,
	...
	"guestsCanInviteOthers": {
		...
		Defaults:     map[string]gsmhelpers.FlagValue{"import": gsmhelpers.BoolVal(true), "insert": gsmhelpers.BoolVal(true)},
	},
	"guestsCanModify": {
		AvailableFor: []string{"insert", "patch"},
		Type:         gsmhelpers.FlagBool,
...
Can be used multiple times to specify more than one reminder override.`,
	...
	"useDefaultReminders": {
		...
		Defaults:     map[string]gsmhelpers.FlagValue{"insert": gsmhelpers.BoolVal(true)},
	},
	"sequence": {
		AvailableFor: []string{"insert", "patch"},
		Type:         gsmhelpers.FlagInt64,
...
If an event changes its organizer (for example via the move operation) and the original organizer is not on the attendee list, it will leave behind a cancelled event where only the id field is guaranteed to be populated.`,
		Defaults: map[string]gsmhelpers.FlagValue{"import": gsmhelpers.StringVal("confirmed"), "insert": gsmhelpers.StringVal("confirmed")},
	},
	"summary": {
		AvailableFor: []string{"insert", "patch"},
		Type:         gsmhelpers.FlagString,
...
transparent  - The event does not block time on the calendar. This is equivalent to setting Show me as to Available in the Calendar UI.`,
		Defaults: map[string]gsmhelpers.FlagValue{"import": gsmhelpers.StringVal("opaque"), "insert": gsmhelpers.StringVal("opaque")},
	},
	"visibility": {
		AvailableFor: []string{"insert", "patch"},
		Type:         gsmhelpers.FlagString,
...
confidential  - The event is private. This value is provided for compatibility reasons.`,
		Defaults: map[string]gsmhelpers.FlagValue{"import": gsmhelpers.StringVal("default"), "insert": gsmhelpers.StringVal("default")},
	},
	"iCalUID": {
