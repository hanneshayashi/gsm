...
var attachmentsGetBatchCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		flags, err := gsmhelpers.ConsolidateFlags(cmd, attachmentFlags)
		if err != nil {
...
func init() {
	gsmhelpers.InitBatchCommand(attachmentsGetCmd, attachmentsGetBatchCmd, attachmentFlags, attachmentFlagsALL, batchFlags)
}
