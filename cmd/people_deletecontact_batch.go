...
var peopleDeleteContactBatchCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		flags, err := gsmhelpers.ConsolidateFlags(cmd, peopleFlags)
		if err != nil {
...
func init() {
	gsmhelpers.InitBatchCommand(peopleDeleteContactCmd, peopleDeleteContactBatchCmd, peopleFlags, peopleFlagsALL, batchFlags)
}
