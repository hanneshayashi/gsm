...
// driveLabelsDeleteFieldCmd represents the deleteField command
var driveLabelsDeleteFieldCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		r, err := mapToDeleteDriveLabelFieldRequest(flags)
		if err != nil {
			log.Fatalf("Error building Drive Label DeleteFieldRequest object: %v\n", err)
		}
...
func init() {
	gsmhelpers.InitCommand(driveLabelsCmd, driveLabelsDeleteFieldCmd, driveLabelFlags)
}
