...
// commentsGetCmd represents the get command
...
func init() {
	...
	gsmhelpers.AddFlags(commentFlags, commentsGetCmd.Flags(), commentsGetCmd.Use)
	markFlagsRequired(commentsGetCmd, commentFlags, "")
}
