...
func init() {
	calendarListsCmd.AddCommand(calendarListsPatchCmd)
	gsmhelpers.AddFlags(calendarListFlags, calendarListsPatchCmd.Flags(), calendarListsPatchCmd.Use)
	markFlagsRequired(calendarListsPatchCmd, calendarListFlags, "")
}
