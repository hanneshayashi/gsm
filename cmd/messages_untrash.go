...
func init() {
	messagesCmd.AddCommand(messagesUntrashCmd)
	gsmhelpers.AddFlags(messageFlags, messagesUntrashCmd.Flags(), messagesUntrashCmd.Use)
	markFlagsRequired(messagesUntrashCmd, messageFlags, "")
}
